...
export const flagMappings: FlagMatch[] = [
  { flag: "iq", keywords: ["العراق", "بغداد", "بصره", "بابل", "الموصل", "أربيل", "اربيل", "الأنبار", "كربلاء", "النجف", "صلاح الدين", "كركوك", "ميسان", "الناصرية", "السليمانية", "السليمانيه", "دهوك", "كردستان", "كوردستان", "حلبجة", "Erbil", "Kurdistan"] },
