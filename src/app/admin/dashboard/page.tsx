                                    ...
                                    <tr key={`${post.telegram_id}-${post.language}`} className="hover:bg-white/[0.01] transition-colors group">
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <div className="flex justify-end gap-3">
                                                ...
                                                <button onClick={() => handleDelete(post.telegram_id, post.language)} className="text-gray-500 hover:text-red-500 transition-colors p-2 hover:bg-red-500/5 rounded-lg">
